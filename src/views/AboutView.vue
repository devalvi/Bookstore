<template>
  ...
  <div class="profile-card js-profile-card">
    <div class="profile-card__img">
      <img src="../assets/me.png" alt="profile card">
    </div>

    <div class="profile-card__cnt js-profile-cnt">
      <div class="profile-card__name">Ian Aluvi</div>
      ...
      <div class="profile-card-social">
        <a href="https://twitter.com/dev_alvi" class="profile-card-social__item twitter" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-twitter"></use></svg>
          </span>
        </a>

        <a href="https://github.com/devalvi" class="profile-card-social__item github" target="_blank">
          <span class="icon-font">
              <svg class="icon"><use xlink:href="#icon-github"></use></svg>
          </span>
        </a>

        <a href="#my website" class="profile-card-social__item link" target="_blank">
          <span class="icon-font">
      ...
      <div class="profile-card-ctr">
        <button class="profile-card__button button--blue js-message-btn">Contact Me</button>
      </div>
    </div>
...
@font-face {
    ...
    src: url('../assets/national-bold.ttf');
}
html {
  position: relative;
...
.profile-card__img {
  ...
  position: relative;
  z-index: 4;
  box-shadow: 0px 1px 1px 0px #065142, 0px 0px 0px 1px #065142;
}
